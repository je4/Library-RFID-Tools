 ...
 *
 */
public class ElatecException extends Exception {
	...
	private static final String[] errMsg = { "no error", "unknown function", "missing parameter", "unused parameters",
			"invalid function", "parser error", "unknown error" };

	/**
	 * 
	 */
	public ElatecException(byte result) {
		super( String.valueOf(result) + ": " + errMsg[Math.min( result < 0 ? 6 : result , 6)] );
		errNo = result;
	}
